...
require("../mval/email_validation.php");
$validator=new email_validation_class;
	...
	*/
	...
	$validator->invalid_email_domains_file = '../mval/invalidemaildomains.csv';
	$validator->invalid_email_servers_file = '../mval/invalidemailservers.csv';
	$validator->email_domains_white_list_file = '../mval/emaildomainswhitelist.csv';
...
if(isset($_GET['email'])){
		...
		if(strlen($error = $validator->ValidateAddress($email, $valid)))
		{
			$content2 .= "<tr>\n";
							$content2 .="                          <td>1</td>\n";
							$content2 .="							<td id=el1 value=$email>$email</td>\n";
							$content2 .="							<td>Error: ".HtmlSpecialChars($error)."</td>\n";
							$content2 .="							<td></td>\n";
							$content2 .="                        </tr>\n"; 
		}
		elseif(!$valid)
		{
							...
							$content2 .="                          <td>1</td>\n";
							$content2 .="							<td id=el1 value=$email>$email</td>\n";
							$content2 .="							<td>False Set By Server</td>\n";
							$content2 .="							<td></td>\n";
							$content2 .="                        </tr>\n"; 
		}
		elseif(($result=$validator->ValidateEmailBox($email))<0){
			...
			if($result == ''){
							...
							$content2a .="                          <td>2</td>\n";
							$content2a .="							<td id=ml1 value=$email>$email</td>\n";
							$content2a .="							<td>Success</td>\n";
							$content2a .="							<td><input class=\"form-group\" id=mc1 name=\"\" type=\"checkbox\" value=$email</td>\n";
							$content2a .="                        </tr>\n"; 
			}
